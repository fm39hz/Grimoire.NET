...
public interface ISeriesExportRecordRepository : IRepository<SeriesExportRecord> {
	public Task<SeriesExportRecord?> GetBySeriesAndFormatAsync(Guid seriesId, string format, CancellationToken cancellationToken = default);
	...
	/// </summary>
	public Task<DateTime> GetMaxContentTimestampAsync(Guid seriesId, CancellationToken cancellationToken = default);
}
